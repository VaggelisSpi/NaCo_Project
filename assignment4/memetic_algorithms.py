...
def simple_EA(
    cities: List[float], sigma: int, N: int, K: int, p: float = 0.1, m: float = 0.01, generations: int = 1000
):
    """
...
def memetic(cities: List[float], sigma: int, N: int, K: int, p: float = 0.1, m: float = 0.1, generations: int = 1000):
    """
    cities: list with city coordinates
    sigma: alphabet (size)
    N: population size
